...
@section('content')
    <div class="dm-container container">
                ...
                <div class="form-container">
                    <form name="textarea">
                        <div class="form-group">
                            <label for="form-body">{{ $user_name }}　さんへの相談内容</label>
                        ...
                        <div class="required-coin row">
                            <div class="message col-md-5">
                                <p>必要コイン数：<span>{{ $required_coin }}枚</span></p>
                            </div>
                        </div>
        ...
        <div id="contact-confirm-modal">
            <div class="contact-confirm-form container">
                ...
                <form action="{{ route('dm.send') }}" method="POST">
                    {{ csrf_field() }}
    ...
    <script>
        var coin_judgment = <?php echo json_encode($coin_judgment); ?>;
    </script>
@endsection